...
const App = () => {
  ...
  const applyFilters = (nameFilter, populationFilter) => {
    ...
    <div className='country-container'>
      <div className="country-header">
        ...
        <div className="country-filters-container">
          ...
          />
          <ShowTableButton showTable={showTable} toggleShowTable={toggleShowTable} />
        </div>
      </div>
      <div className="country-body">
        {showTable && <CountriesTable isLoading={isLoading} data={filteredCountries} />}
      </div>
